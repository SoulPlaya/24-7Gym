...
// .wrangler/tmp/bundle-BklyDh/strip-cf-connecting-ip-header.js
...
`;
var classes_default = pricingPage;
...
app.get("/classes", (c) => {
  return c.html(layout_default("Classes", classes_default));
});
app.get("/contact", (c) => {
  return c.html(layout_default("Contact Us", contact_default));
});
app.get("/login", (c) => {
  return c.html(layout_default("login", login_default));
});
var src_default = app;
...
// .wrangler/tmp/bundle-BklyDh/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BklyDh/middleware-loader.entry.ts
